        ...
        <div className="lg:flex lg:justify-between lg:gap-4">
          ...
          <main className="pt-24 lg:w-1/2 lg:py-24">
            ...
            <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
              <div className={`sticky top-0 z-20 -mx-6 mb-4 w-screen px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0 transition-colors duration-300 ${
                isDarkMode ? 'bg-black/75' : 'bg-amber-50/75'
              }`}>
                <h2 className={`text-sm font-bold uppercase tracking-widest lg:sr-only transition-colors duration-300 ${
                  isDarkMode ? 'text-slate-200' : 'text-amber-950'
                }`}>
                  About
                </h2>
